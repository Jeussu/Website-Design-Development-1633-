...
<form class="add_user" action="add_user.php" method="POST">  
    Username: <input type="text" class = "input_box" name="username" 
    maxlength="15" size="20" required> <br> <br>
    Password: <input type="password" class = "input_box_custom" name="password" 
    maxlength="15" size="20" required> <br> <br>
    <input type="submit" class = "black_button" name="add" value="Add">
</form>
</center>